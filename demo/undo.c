...
void
undo_reset (undo_action_t * undo)
{
  if (undo->last_action == NOTHING)
    return;
...
void
undo_free (undo_action_t * undo)
{
  if (undo->last_action == REMOVE)
    item_free (undo->removed);
...
last_action_t
undo_get_last_action (undo_action_t * undo)
{
  return undo->last_action;
}

void
undo_set_last_action (undo_action_t * undo, last_action_t action)
{
  undo->last_action = action;
}

elem_t
undo_get_edit_old (undo_action_t * undo)
{
  return undo->edit_old;
}

void
undo_set_edit_old (undo_action_t * undo, elem_t added)
{
  undo->edit_old = item_deep_copy (added);
}

elem_t
undo_get_edit_new (undo_action_t * undo)
{
  return undo->edit_new;
}

void
undo_set_edit_new (undo_action_t * undo, elem_t added)
{
  undo->edit_new = item_deep_copy (added);
}

elem_t
undo_get_removed (undo_action_t * undo)
{
  return undo->removed;
}

void
undo_set_removed (undo_action_t * undo, elem_t added)
{
  undo->removed = item_deep_copy (added);
}

elem_t
undo_get_added (undo_action_t * undo)
{
  return undo->added;
}

void
undo_set_added (undo_action_t * undo, elem_t added)
{
...
void
undo_last_action (tree_t * db, undo_action_t * undo)
{
